...
const eLgallery = document.querySelector(".js-gallery");
const eLslides = eLgallery.querySelectorAll(".js-gallery-item");
...
const slideWidth = eLslides[0].offsetWidth;
...
const transitionSlide = () => {
  if (currentSlide < slideCount) {
    eLgallery.style.transform = `translateX(-${slideWidth * currentSlide}px)`;
    currentSlide++;
  } else {
    eLgallery.style.transform = "translateX(0px)";
    currentSlide = 1;
  }
};
