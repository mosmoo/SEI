...
- The first value of each nested array will be a string, the second an integer.
...
- If any of the nested arrays have a string where all of the character's character code does not
  match the integer, then return false.
Hints:
